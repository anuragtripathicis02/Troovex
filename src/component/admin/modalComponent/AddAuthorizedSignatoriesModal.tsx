...
const AddAuthorizedSignatoriesModal = ({ show, handleClose }: any) => {
    type Member = {
    name: string;
    ownerType: string;
    ownership: string;
 ...
 const handleChange = (
  ...
  return (
    <Modal show={show} onHide={handleClose} centered className="common-modal lg-modal pt-lg-4 pt-5">
        ...
        <Modal.Header>
            <Modal.Title>
                <h5 className='m-0'>Add Authorized Signatories </h5>
            </Modal.Title>
        </Modal.Header>
        <Modal.Body className="common-modal-body">
            ...
            <div className='member-list-add-card' key={index}>
                <div className='row align-items-center pe-60 position-relative'>
                    ...
                    <div className='col'>
                        <div className='mb-3'>
                            <FloatingLabel controlId="floatingSelect" label="Authorization Scope">
                            <Form.Select aria-label="Authorization Scope"  value={member.ownerType} onChange={(e) => handleChange(index, "ownerType", e.target.value) }>
                                <option>Authorization Scope</option>
                                <option value="1">Authorization Scope 1</option>
                                <option value="2">Authorization Scope 2</option>
                                <option value="3">Authorization Scope 3</option>
                            </Form.Select>
                            </FloatingLabel>
                        </div>
                    </div>
...
export default AddAuthorizedSignatoriesModal