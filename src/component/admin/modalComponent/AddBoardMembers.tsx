...
const AddBoardMembers = ({ show, handleClose }: any) => {
    return (
        <Modal show={show} onHide={handleClose} centered className="common-modal md-modal pt-lg-4 pt-5">
            ...
            <Modal.Header>
                <Modal.Title>
                    <h5 className='m-0'>Add References</h5>
                </Modal.Title>
            </Modal.Header>
            <Modal.Body className="common-modal-body">
                <div className='row'>
                    <div className='col-md-12 mb-4'>
                        <FloatingLabel controlId="floatingInput" label="Organization Name" >
                            <Form.Control type="text" placeholder="Joseph Seeds" />
                        </FloatingLabel>
                    </div>
                    <div className='col-md-6 mb-4'>
                        <FloatingLabel controlId="floatingSelect" label="Organization Domain">
                    ...
                    <div className='col-md-6 mb-4'>
                        <FloatingLabel controlId="floatingInput" label="Contact Person Name">
