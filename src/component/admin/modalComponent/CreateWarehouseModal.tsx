...
const CreateWarehouseModal = ({ show, handleClose }: any) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} centered className="common-modal md-modal pt-lg-4 pt-5">
        ...
        <Modal.Header>
            <Modal.Title>
                <h5 className='m-0'>Create Warehouse</h5>
            </Modal.Title>
        </Modal.Header>
        <Modal.Body className="common-modal-body">
            <div className="row pt-3">
                <div className='col-md-12 mb-4'>
                    <FloatingLabel controlId="floatingInput" label="Warehouse Title" className="mb-0">
                        <Form.Control type="text" placeholder="Warehouse Title" />
                    </FloatingLabel>
                </div>
                <div className='col-lg-6 col-md-12 mb-4'>
                    <FloatingLabel controlId="floatingInput" label="Storage Capacity" className="mb-0">
                        <Form.Control type="text" placeholder="Storage Capacity" />
                    </FloatingLabel>
                </div>
                <div className='col-lg-6 col-md-12 mb-4'>
                    <FloatingLabel controlId="floatingSelect" label="Region">
                        <Form.Select aria-label="Region">
                            <option>Douaouda, Algeria</option>
                            <option value="1">Douaouda, Algeria 1</option>
                            <option value="2">Douaouda, Algeria 2</option>
                            <option value="3">Douaouda, Algeria 3</option>
                        </Form.Select>
                    </FloatingLabel>
                </div>
                <div className='col-md-12 mb-4'>
                    <FloatingLabel controlId="floatingInput" label="Warehouse Address" className="mb-0">
                        <Form.Control type="text" placeholder="Warehouse Address" />
                    </FloatingLabel>
                </div>
                <div className='col-md-12 mb-12'>
                    <div className="multipal-select-sec mb-2 position-relative floting-box">
                        ...
                        <TagInput defaultValue={["Cold storage", "Hazardous materials", "Bulk storage", "Secure storage"]}
