...
const AddBoardMembersModal = ({ show, handleClose }: any) => {
    type Member = {
    name: string;
    ownerType: string;
    ownership: string;
        ...
        <Modal.Body className="common-modal-body">
            ...
            <div className='member-list-add-card' key={index}>
                <div className='row align-items-center pe-60 position-relative'>
                    <div className='col'>
                        <FloatingLabel controlId="floatingInput" label="Full Name / Legal Entity Name" className="mb-3">
                            <Form.Control type="text"  placeholder="Full Name / Legal Entity Name"  value={member.name} onChange={(e) => handleChange(index, "name", e.target.value)}/>
                        </FloatingLabel>
                    </div>
                    <div className='col'>
                        <div className='mb-3'>
                            <FloatingLabel controlId="floatingSelect" label="Owner Type">
                            <Form.Select aria-label="Owner Type"  value={member.ownerType} onChange={(e) => handleChange(index, "ownerType", e.target.value) }>
                                <option>Owner Type</option>
                                <option value="1">Owner Type 1</option>
                                <option value="2">Owner Type 2</option>
                                <option value="3">Owner Type 3</option>
                            </Form.Select>
                            </FloatingLabel>
                        </div>
                    </div>
