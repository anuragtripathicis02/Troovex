...
const AddSoftwareLicensesModal = ({ show, handleClose }: any) => {
  return (
    <Modal show={show} onHide={handleClose} centered className="common-modal md-modal pt-lg-4 pt-5">
        ...
        <Modal.Header>
            <Modal.Title>
                <h5 className='m-0'>Add Software & Licenses</h5>
            </Modal.Title>
        </Modal.Header>
        <Modal.Body className="common-modal-body">
            <div className="row pt-2">
                <div className=' col-md-12 mb-4'>
                    <FloatingLabel controlId="floatingInput" label="Software Title" className="mb-0">
                        <Form.Control type="text" placeholder="Software Title" />
                    </FloatingLabel>
                </div>
                <div className='col-xl-8 col-md-12 mb-0'>
                    <div className='row'>
                        <div className='col-md-12 mb-4'>
                            <FloatingLabel controlId="floatingInput" label="Software Version" className="mb-0">
                                <Form.Control type="text" placeholder="Software Version" />
                            </FloatingLabel>
                        </div>
                        <div className='col-md-12 mb-4'>
                            <FloatingLabel controlId="floatingSelect" label="License Type">
                                <Form.Select aria-label="License Type">
                                    <option>Annual License</option>
                                    <option value="1">Annual License One</option>
                                    <option value="2">Annual License Two</option>
                                    <option value="3">Annual License Three</option>
                                </Form.Select>
                            </FloatingLabel>
                        </div>
                        <div className='col-md-12 mb-4'>
...
export default AddSoftwareLicensesModal