...
const FinancialStrengthRiskIndicators = () => {
    return (
        <div className='row pt-4'>
            <div className='col-md-12 mb-4'>
                <FloatingLabel controlId="floatingInput" label="Credit Rating (if available)" className=" ">
                    <Form.Control type="text" placeholder="Credit Rating (if available)" />
                </FloatingLabel>
            </div>
            ...
            <div className='col-xxl-4 col-md-6 mb-4'>
                <FloatingLabel controlId="floatingInput" label="Insurance Provider Name" className=" ">
                    <Form.Control type="text" placeholder="Insurance Provider Name" />
                </FloatingLabel>
            </div>
            <div className='col-xxl-4 col-md-12 mb-4'>
                <FloatingLabel controlId="floatingSelect" label="Insurance Type">
                    <Form.Select aria-label="Insurance Type">
                        <option>Professional liability</option>
                        <option value="1">Professional liability 1</option>
                        <option value="2">Professional liability 2</option>
                        <option value="3">Professional liability 3</option>
                    </Form.Select>
                </FloatingLabel>
            </div>
            <div className='col-xxl-4 col-md-6 mb-4'>
                <FloatingLabel controlId="floatingInput" label="Coverage Amount" className=" ">
                    <Form.Control type="text" placeholder="Coverage Amount" />
                </FloatingLabel>
            </div>
            <div className='col-md-12 mb-4'>
                <FloatingLabel controlId="floatingTextarea2" label="Provider Contact Details" className="">
                    <Form.Control as="textarea" placeholder="Provider Contact Details" style={{ height: '100px' }} />
                </FloatingLabel>
            </div>
            <div className='col-md-12 mb-4'>
                <div className="list-card-box d-flex align-items-center gap-0 justify-content-between flex-wrap">
                    <FileUploadList title="Insurance Policy" required />
                </div>
            </div>
            <div className='col-md-12 mb-4'>
...
export default FinancialStrengthRiskIndicators