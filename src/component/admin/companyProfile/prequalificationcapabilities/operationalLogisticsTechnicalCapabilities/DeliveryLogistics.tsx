...
import AddInformationModal from "@/component/admin/modalComponent/AddInformationModal";
  ...
  return (
    <div className='row'>
        <div className="col-md-12 mb-4">
            <FloatingLabel controlId="floatingTextarea2" label="Comments" className="mb-0">
                        ...
                        <div className="action-right">
                            <div className="d-flex align-items-center gap-2">
                                <button className="btn-outline btn-gray d-inline-flex align-items-center gap-1">
                                    ...
                                    Import</button>
                                <button onClick={handleSubsidiaries} className="btn-outline btn-light-blue d-inline-flex align-items-center gap-1"><svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <Table className="text-center align-middle mb-2 p-0 " responsive hover>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Road, Sea, Air, Rail, Courier</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>Standard: 485 min; Express: 240 min; Bulk: 720 min</td>
                                    <td>
                                        <Link href='' className="d-flex text-nowrap gap-2">
                                            <AttachmentIcon />
                                            View Attachment
                                ...
                                <tr>
                                    ...
                                    <td>Algiers, Oran, Constantine, Annaba, Sétif, Blida, Batna, Djelfa, etc.</td>
                                    <td>
                                        <Link href='' className="d-flex text-nowrap gap-2">
                                            <AttachmentIcon />
                                            View Attachment
                                ...
                                <tr>
                                    ...
                                    <td>12 trucks, 3 refrigerated vans, 2 forklifts, 1 drone delivery pilot</td>
                                    <td>
                                        <Link href='' className="d-flex text-nowrap gap-2">
                                            <AttachmentIcon />
                                            View Attachment
                                ...
                                <tr>
                                    ...
                                    <td>GPS tracking, route optimization software, real-time delivery dashboard</td>
                                    <td>
                                        <Link href='' className="d-flex text-nowrap gap-2">
                                            <AttachmentIcon />
                                            View Attachment
        ...
        <AddInformationModal show={showSubsidiaries} handleClose={handleCloseAll} />
    </div>
  )
}
