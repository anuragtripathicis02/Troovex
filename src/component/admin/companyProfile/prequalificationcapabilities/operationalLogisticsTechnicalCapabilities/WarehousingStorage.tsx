...
import CreateWarehouseModal from '@/component/admin/modalComponent/CreateWarehouseModal'
  ...
  return (
    <div className="row pt-3">
        <div className='col-md-12 mb-4'>
            <FloatingLabel controlId="floatingSelect" label="Warehouse / Storage Facilities Available">
                <Form.Select aria-label="Warehouse / Storage Facilities Available">
                    <option>Yes</option>
        ...
        <div className='col-12 mb-2'>
            <div className="d-flex align-items-center gap-2 mb-2 flex-wrap list-card-member-box oprational-box  justify-content-between">
                <div className="left-details-member  first-oprational-box">
                    <div className="author-text-box">
                        <p className="name">EURL DANIMEX</p>
                        <div className="d-flex align-items-center gap-2 flex-wrap">
                            <p className="type">24000 Kg </p>
                            <span> | </span>
                            <p className="ownship">Cold Storage, Hazardous materials</p>
                        </div>
                    </div>
                </div>
                <div className="left-details-member">
                    <div className="author-text-box">
                        ...
                        <div className="d-flex align-items-center gap-2 flex-wrap">
                            <p className="type">MQMR+RJX, Douaouda, Algeria </p>
                        </div>
                    </div>
                </div>
        ...
        <div className='col-12 mb-2'>
            <div className="d-flex align-items-center gap-2 mb-2 flex-wrap list-card-member-box oprational-box justify-content-between">
                <div className="left-details-member first-oprational-box">
                    <div className="author-text-box">
                        <p className="name">Sarl Container Space Entrepôt</p>
                        <div className="d-flex align-items-center gap-2 flex-wrap">
                            <p className="type">2400sqft </p>
                            <span> | </span>
                            <p className="ownship">Warehouse</p>
                        </div>
                    </div>
                </div>
                <div className="left-details-member">
                    <div className="author-text-box">
                        <p className="name">Location:</p>
                        <div className="d-flex align-items-center gap-2 flex-wrap">
                            <p className="type">P982+X7C, Ouled Hedadj, Algeria </p>
                        </div>
                    </div>
                </div>
                <ul className="p-0 m-0 list-unstyled d-flex align-items-center gap-2">
        ...
        <div className='col-12 mb-4'>
            <div className="action-right">
                <div className="d-flex align-items-center gap-4 btn-default-box pt-2">
        ...
        <CreateWarehouseModal show={showSubsidiaries} handleClose={handleCloseAll} />
        <AddBoardMembersModalCSV show={showAddMemberCSV} handleClose={handleCloseAll} />
    </div>
  )
}

export default WarehousingStorage