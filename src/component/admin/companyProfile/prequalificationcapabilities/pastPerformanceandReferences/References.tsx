...
import AuthorImg from "../../../../../app/images/user-avtar.png"
import AddBoardMembers from "@/component/admin/modalComponent/AddBoardMembers";


const References = () => {

    const [showAddBordMember, setShowAddBordMember] = useState(false);
    const handleAddBordMember = () => {
        setShowAddBordMember(true);
    };

    const handleCloseAll = () => {
        setShowAddBordMember(false);
    };

    return (
        <>
            <div className="board-member-box">
                <div className="board-member-list member-applicable-box">
                    <div className="d-flex align-items-center gap-2 mb-2 flex-wrap list-card-member-box justify-content-between">
                        <div className="left-details-member d-flex flex-wrap align-items-center gap-md-2 gap-1">
                            <div className="author-img">
                                <Image src={AuthorImg} alt=""></Image>
                            </div>
                            <div className="author-text mt-md-0 mt-2">
                                <p className="name">Mike Miller</p>
                                <span className="d-block text-dish">Goods & Services</span>
                            </div>
                            <div className="manager">
                                <p>Mike Miller</p>
                                <p>+223 1234567 | mikem@suninfra.com</p>
                            </div>
                        </div>
                    ...
                    <div className="d-flex align-items-center gap-2 mb-2 flex-wrap list-card-member-box justify-content-between">
                        <div className="left-details-member d-flex flex-wrap align-items-center gap-md-2 gap-1">
                            ...
                            <div className="author-text mt-md-0 mt-2">
                                <p className="name">L&T Power Co.</p>
                                <span className="d-block text-dish">Goods</span>
                            </div>
                            <div className="manager">
                                <p>Mike Miller</p>
                                <p>+223 1234567 | mikem@suninfra.com</p>
                    ...
                    <div className="d-flex align-items-center gap-2 mb-2 flex-wrap list-card-member-box justify-content-between">
                        <div className="left-details-member d-flex flex-wrap align-items-center gap-md-2 gap-1">
                            ...
                            <div className="author-text mt-md-0 mt-2">
                                <p className="name">Signac Tech</p>
                                <span className="d-block text-dish">Work</span>
                            </div>
                            <div className="manager">
                                <p>Mike Miller</p>
                                <p>+223 1234567 | mikem@suninfra.com</p>
                ...
                <div className="action-right">
                    <div className="d-flex align-items-center gap-4 btn-default-box pt-4 pb-4">
                        <button type="button" className="d-inline-flex align-items-center gap-1 p-0 btn-grey-text border-0 bg-transparent" onClick={handleAddBordMember}>
                        ...
                        <button type="button" className="d-inline-flex align-items-center gap-1 p-0 btn-blue-text border-0 bg-transparent">
            ...
            <AddBoardMembers show={showAddBordMember} handleClose={handleCloseAll} />
            </div>
        </>
    )
}
