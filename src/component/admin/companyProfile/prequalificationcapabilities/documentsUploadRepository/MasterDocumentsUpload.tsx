...
const MasterDocumentsUpload = () => {
  return (
    <div className='row'>
        <div className='col-md-12'>
            <div className="upload-file-sec">
                <FileUploadItem title="Company Registration Certificate" required />
                <FileUploadItem title="Tax Card" required/>
                <FileUploadItem title="Bank Certificate (RIB / IBAN)" required/>
                <FileUploadItem title="ID of Legal Representative" required/>
                <FileUploadItem title="Signature Specimen" required/>
                <FileUploadItem title="Insurance Certificate" required/>
                <FileUploadItem title="Procurement Policy" required/>
                <FileUploadItem title="Ethics Charter" required/>
                <FileUploadItem title="Sustainability Policy" required/>
                <FileUploadItem title="Financial Statements" optional />
            </div>

            <div className="d-flex align-items-center gap-4 btn-default-box pt-4 pb-3">
                <button type="button"  className="d-inline-flex align-items-center gap-1 p-0 btn-grey-text border-0 bg-transparent">
...
export default MasterDocumentsUpload