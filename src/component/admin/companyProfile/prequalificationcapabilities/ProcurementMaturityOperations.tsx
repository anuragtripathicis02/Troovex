...
import EmployeesRoles from "./humanResourcesCapabilities/EmployeesRoles";
import QualityProductionControls from "./procurementMaturityOperations/QualityProductionControls";


const ProcurementMaturityOperations = () => {
  ...
  return (
    <div className='card-wrapper'>
      <div className="card-head">
        <h4 className='mb-0'>Procurement Maturity & Operations</h4>
...
export default ProcurementMaturityOperations