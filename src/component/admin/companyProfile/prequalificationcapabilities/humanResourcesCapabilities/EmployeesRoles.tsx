...
import CreateEmployeeModal from "@/component/admin/modalComponent/CreateEmployeeModal";
...
const EmployeesRoles = () => {
  ...
  return (
    <div className="employees-roles-sec">
      <div className="employees-roles-list mt-0"> 
        <Table responsive className="table-fixed-sec">
          <tbody>
            <tr className=" border-box">
              <td>
                <p>
                  <strong>Mike Miller</strong>
                  <span className="d-block">Relationship Manager @Customer Support</span>
                </p>
              </td>
              <td>
                <p>+122 1234567890 <span className="d-block">mikemiller@gmail.com</span></p>
              </td>
              <td>
                <p>Level 3 <span className="d-block">Full Time</span></p>   
              </td>
              <td>
                <p>CNAS No. <span className="d-block">#1234567890</span></p>
              </td>
              <td>
                <ul className="p-0 m-0 list-unstyled d-flex align-items-center justify-content-end gap-2">
                  <li>
                    <Dropdown align="end">
                      <Dropdown.Toggle className="default-btn-dropdown">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="40" height="40" rx="8" fill="#F6F6F6"/><path d="M21.125 20C21.125 20.2225 21.059 20.44 20.9354 20.625C20.8118 20.81 20.6361 20.9542 20.4305 21.0394C20.225 21.1245 19.9988 21.1468 19.7805 21.1034C19.5623 21.06 19.3618 20.9528 19.2045 20.7955C19.0472 20.6382 18.94 20.4377 18.8966 20.2195C18.8532 20.0012 18.8755 19.775 18.9606 19.5695C19.0458 19.3639 19.19 19.1882 19.375 19.0646C19.56 18.941 19.7775 18.875 20 18.875C20.2984 18.875 20.5845 18.9935 20.7955 19.2045C21.0065 19.4155 21.125 19.7016 21.125 20ZM20 14.75C20.2225 14.75 20.44 14.684 20.625 14.5604C20.81 14.4368 20.9542 14.2611 21.0394 14.0555C21.1245 13.85 21.1468 13.6238 21.1034 13.4055C21.06 13.1873 20.9528 12.9868 20.7955 12.8295C20.6382 12.6722 20.4377 12.565 20.2195 12.5216C20.0012 12.4782 19.775 12.5005 19.5695 12.5856C19.3639 12.6708 19.1882 12.815 19.0646 13C18.941 13.185 18.875 13.4025 18.875 13.625C18.875 13.9234 18.9935 14.2095 19.2045 14.4205C19.4155 14.6315 19.7016 14.75 20 14.75ZM20 25.25C19.7775 25.25 19.56 25.316 19.375 25.4396C19.19 25.5632 19.0458 25.7389 18.9606 25.9445C18.8755 26.15 18.8532 26.3762 18.8966 26.5945C18.94 26.8127 19.0472 27.0132 19.2045 27.1705C19.3618 27.3278 19.5623 27.435 19.7805 27.4784C19.9988 27.5218 20.225 27.4995 20.4305 27.4144C20.6361 27.3292 20.8118 27.185 20.9354 27C21.059 26.815 21.125 26.5975 21.125 26.375C21.125 26.0766 21.0065 25.7905 20.7955 25.5795C20.5845 25.3685 20.2984 25.25 20 25.25Z" fill="#696873"/></svg>
                      </Dropdown.Toggle>
        ...
        <div className="action-right">
            <div className="d-flex align-items-center gap-4 btn-default-box pt-2 pb-4">
        ...
        <CreateEmployeeModal show={showSubsidiaries} handleClose={handleCloseAll} />
