...
const DigitalPresenceAndContactInformation = () => {
    const [fileSelected, setFileSelected] = useState(false);
    return (
        <div className='row'>
            <div className='col-md-12 col-md-12'>
                <Form.Group controlId="formFile" className="mb-4 position-relative upload-input-box form-group">
            ...
            <div className='col-md-6'>
                <div className="mb-4">
                    <FloatingLabel controlId="floatingInput" label="Official Company Email Domain" className="mb-3 floating-white-color filled-box filled-bg show-placeholder-text black-filed">
            ...
            <div className="col-md-6">
                <div className="fleg-box mb-4 position-relative floting-box black-filed">
                    <OnlyFlagPhoneInput label="Primary Phone Number" />
                </div>
            </div>
            <div className="col-md-6">
                <FloatingLabel controlId="floatingInput" label="Fax Number" className="mb-4">
                    <Form.Control type="text" placeholder="Holding Organization Name (if applicable)" />
                </FloatingLabel>
            </div>
            <div className="col-md-6">
                <div className="fleg-box mb-4 position-relative floting-box black-filed">
                    <OnlyFlagPhoneInput label="Secondary Phone Number" />
                </div>
            </div>
            <div className="col-12 mb-4">
                <div className="d-flex gap-3 align-items-center">
                    <span className="fs-14">Social Profile</span>
                    <hr className="flex-grow-1"></hr>
                </div>
            </div>
            <div className="col-md-4">
                <FloatingLabel controlId="floatingSelect" label="Select Platform" className="mb-4">
...
export default DigitalPresenceAndContactInformation
