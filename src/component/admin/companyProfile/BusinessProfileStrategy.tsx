                    ...
                    <Accordion.Item eventKey="4" className={completed.includes("4") ? "completed" : ""}>
                        <Accordion.Header className="position-relative">
                            <div className="me-auto d-flex align-items-center gap-2">
                                ...
                                <span>Business Model & Market Focus</span>
                            </div>
                            <Arrowaccordion />
                        </Accordion.Header>
                        <Accordion.Body>
                            <BusinessModelMarketFocus />
                            <div className="card-foot">
                                <hr></hr>
                                <div className="d-flex align-items-center justify-content-end">
                    ...
                    <Accordion.Item eventKey="5" className={completed.includes("5") ? "completed" : ""}>
                        <Accordion.Header className="position-relative">
                            <div className="me-auto d-flex align-items-center gap-2">
                                ...
                                <span>Capacity & Competitiveness</span>
                            </div>
                            <Arrowaccordion />
                        </Accordion.Header>
                        <Accordion.Body>
                    ...
                    <Accordion.Item eventKey="6" className={completed.includes("6") ? "completed" : ""}>
                        <Accordion.Header className="position-relative">
                            <div className="me-auto d-flex align-items-center gap-2">
                                ...
                                <span>Financial & Business Scale</span>
                            </div>
                            <Arrowaccordion />
                        </Accordion.Header>
                        <Accordion.Body>
                           <FinancialBusinessScale />
                            <div className="card-foot">
                                <hr></hr>
                                <div className="d-flex align-items-center justify-content-end">
