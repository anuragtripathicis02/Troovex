...
const MethodsofAwardingContractsTenders = () => {
        ...
        <>
            <div className='mb-0'>
                ...
                <div className='row'>
                    <div className='col-xxl-6'>
                        <div className='col-12 mb-3'>
                            <div className="multipal-select-sec mb-2 position-relative floting-box">
                                ...
                                <TagInput
                                    defaultValue={["Consultation", "Order without consultation", "Restricted consultation", "Direct consultation", "Prequalification", "Selective consultation", "Competition", "Single-source procurement (Gré à gré)"]}
                    ...
                    <div className='col-xxl-6'>
                        <FloatingLabel controlId="floatingSelect" label="Call for Tenders Type" className="mb-4">
                            <Form.Select aria-label="Floating label select example">
                                <option>Open National Tender</option>
                                <option value="1">One</option>
                                <option value="2">Two</option>
                                <option value="3">Three</option>
                            </Form.Select>
                        </FloatingLabel>
                         <FloatingLabel controlId="floatingSelect" label="Contract Type by Threshold" className="mb-4">
                                <Form.Select aria-label="Floating label select example">
                                    <option>Order Form / Service Order (without contract)</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
                                </Form.Select>
                            </FloatingLabel>
                             <FloatingLabel controlId="floatingSelect" label="Required Approval Level" className="mb-4">
                                <Form.Select aria-label="Floating label select example">
...
export default MethodsofAwardingContractsTenders
