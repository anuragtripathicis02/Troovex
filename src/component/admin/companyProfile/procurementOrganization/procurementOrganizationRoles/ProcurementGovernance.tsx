...
import ProcurementGovernanceModal from "@/component/admin/modalComponent/ProcurementGovernanceModal";



const ProcurementGovernance = () => {
        ...
        <>
            <div className='row'>
                <div className='col-xl-4 col-lg-6 col-md-12'>
                    <FloatingLabel controlId="floatingInput" label={<>Total Employees in Procurement</>} className="mb-4">
                        <Form.Control type="text" placeholder="Total Employees in Procurement" />
                    </FloatingLabel>
                </div>
                <div className='col-xl-4 col-lg-6 col-md-12'>
                    <FloatingLabel controlId="floatingInput" label={<>CEO / Managing Director</>} className="mb-4">
                        <Form.Control type="text" placeholder="CEO / Managing Director" />
                    </FloatingLabel>
                </div>
                <div className='col-xl-4 col-lg-6 col-md-12'>
                    <FloatingLabel controlId="floatingInput" label={<>CPO / Head of Procurement</>} className="mb-4">
                        <Form.Control type="text" placeholder="CPO / Head of Procurement" />
                    </FloatingLabel>
                </div>
                <div className="col-md-12">
                    ...
                    <div className="board-member-box">
                        ...
                        <div className="board-member-list mt-3 member-applicable-box">
            ...
            <ProcurementGovernanceModal show={showAddMember} handleClose={handleCloseAll}/>
...
export default ProcurementGovernance
