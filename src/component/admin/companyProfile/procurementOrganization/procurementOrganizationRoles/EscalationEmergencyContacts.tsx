...
const EscalationEmergencyContacts = () => {
        ...
        <>
            <div className='row'>
                <div className='col-xxl-4 col-lg-6 col-md-12'>
                    <FloatingLabel controlId="floatingInput" label={<>Escalation Contact Name</>} className="mb-4">
                        <Form.Control type="text" placeholder="Escalation Contact Name" />
                    </FloatingLabel>
                </div>
                <div className='col-xxl-4 col-lg-6 col-md-12'>
                    <FloatingLabel controlId="floatingInput" label={<>Escalation Contact Email</>} className="mb-4">
                        <Form.Control type="text" placeholder="Escalation Contact Email" />
                    </FloatingLabel>
                </div>
                <div className='col-xxl-4 col-lg-12 col-md-12'>
                    <FloatingLabel controlId="floatingInput" label={<>Escalation Contact Phone</>} className="mb-4">
                        <Form.Control type="text" placeholder="Escalation Contact Phone" />
                    </FloatingLabel>
                </div>
            </div>
            <div className='bottom-box'>
                ...
                <div className='box-border mb-2'>
                    <div className='row'>
                        ...
                        <div className='col-lg-6 col-md-12'>
                            <div className="fleg-box mb-4 mb-md-0 position-relative floting-box">
                                <OnlyFlagPhoneInput label='Escalation Contact Phone' />
                            </div>
                        </div>
                    </div>
                </div>
...
export default EscalationEmergencyContacts
